...
models_summary$lasso <- Lasso_CV(month.yesint.cv.k4.sets,
                                        my.lambda.vals = exp(seq(-20, -6, 0.1)) %>% sort(decreasing = T))
```
...
models_summary$elasticnet = Elastic_Cv(cv.sets = month.yesint.cv.k4.sets,
                                             my.lambda.vals = exp(seq(-20, -6, 0.1)) %>% sort(decreasing = TRUE),
...
plot(models_summary$lasso$beta, pch = 16,
     main = "LASSO & Elasticnet beta estimates",
     xlab = "beta index", ylab = "beta")
points(models_summary$elasticnet$beta, col = "red", pch = 16)
...
plot(models_summary$lasso.poi$beta, pch = 16,
      main = "Poisson LASSO & Elasticnet beta estimates",
     xlab = "beta index", ylab = "beta")
points(models_summary$elasticnet.poi$beta, col = "red", pch = 16)
...
plot(models_summary$scad$beta, pch = 16,
     ...
     xlab = "beta index", ylab = "beta")
points(models_summary$mcp$beta, col = "red", pch = 16)
