...
df_2010_grouped_subsampled_gg$KY_CD = as.integer(df_2010_grouped_subsampled_gg$KY_CD) %>% MapToInteger()
df_2010_grouped_subsampled_gg$LAW_CAT_CD = as.integer(df_2010_grouped_subsampled_gg$LAW_CAT_CD) %>% MapToInteger()
df_2010_grouped_subsampled_gg$AGE_GROUP = as.integer(df_2010_grouped_subsampled_gg$AGE_GROUP) %>% MapToInteger()
df_2010_grouped_subsampled_gg$PERP_SEX = as.integer(df_2010_grouped_subsampled_gg$PERP_SEX) %>% MapToInteger()
df_2010_grouped_subsampled_gg$PERP_RACE = as.integer(df_2010_grouped_subsampled_gg$PERP_RACE) %>% MapToInteger()
df_2010_grouped_subsampled_gg$NTA2020 = as.integer(df_2010_grouped_subsampled_gg$NTA2020) %>% MapToInteger()


df_2011_grouped_subsampled_gg = df_2011_grouped_subsampled

df_2011_grouped_subsampled_gg$KY_CD = as.integer(df_2011_grouped_subsampled_gg$KY_CD) %>% MapToInteger()
df_2011_grouped_subsampled_gg$LAW_CAT_CD = as.integer(df_2011_grouped_subsampled_gg$LAW_CAT_CD) %>% MapToInteger()
df_2011_grouped_subsampled_gg$AGE_GROUP = as.integer(df_2011_grouped_subsampled_gg$AGE_GROUP) %>% MapToInteger()
df_2011_grouped_subsampled_gg$PERP_SEX = as.integer(df_2011_grouped_subsampled_gg$PERP_SEX) %>% MapToInteger()
df_2011_grouped_subsampled_gg$PERP_RACE = as.integer(df_2011_grouped_subsampled_gg$PERP_RACE) %>% MapToInteger()
df_2011_grouped_subsampled_gg$NTA2020 = as.integer(df_2011_grouped_subsampled_gg$NTA2020) %>% MapToInteger()
```
...
IL dataset presenta principalmente esplicative categoriali, benchè le esplicative quantitative (MdAge, MIncome, Pop1) permettano la specificazione di diverse forme funzionali qui, per ragioni computazionali ci si limita ad assumere una relazione monotona lineare con la risposta.
...
Per i dati originali sarebbe stato opportuno o modello con inflazione sia di zeri che di uni, ma per adattarlo servirerebbero delle metodologie ad hoc dato l'eccessivo numero di righe e colonne.
